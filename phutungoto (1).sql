...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 16, 2018 lúc 01:40 PM
...
INSERT INTO `tbl_albumchitiet` (`id_album`, `anhchitiet`, `sanpham_id`) VALUES
...
INSERT INTO `tbl_user` (`id_user`, `hoten`, `sdt`, `email`, `diachi`, `tendangnhap`, `matkhau`) VALUES
...
--
ALTER TABLE `tbl_dsquyen`
  MODIFY `id_dsquyen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tbl_ngdungcapcao`
  MODIFY `id_ndcc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `tbl_hoadon`
  ADD CONSTRAINT `tbl_hoadon_ibfk_1` FOREIGN KEY (`id_khach`) REFERENCES `tbl_user` (`id_user`);
